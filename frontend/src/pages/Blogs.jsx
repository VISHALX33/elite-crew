  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-bold text-orange-600 mb-2">Explore Blogs</h1>
      ...
      <div className="flex justify-between items-center mb-4">
        <p className="text-gray-600">
          Showing <span className="font-semibold text-orange-600">{filteredBlogs.length}</span> blog(s)
        </p>
      </div>
